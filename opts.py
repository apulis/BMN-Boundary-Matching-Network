...
def parse_opt():
    ...
    parser.add_argument('--feature_path', type=str, default="./data/activitynet_feature_cuhk/")
    ...
    parser.add_argument('--feat_dim', type=int, default=400)
    ...
    parser.add_argument('--save_fig_path', type=str, default="./output/evaluation_result.png")
